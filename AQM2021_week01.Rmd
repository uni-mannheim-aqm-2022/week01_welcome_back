...
2. **Post your question on ILIAS**. I opened a forum already. Use it to ask questions and share materials with your fellow students. I encourage you to use it.
3. **Come to my office hours**. I have 90 minutes on Mondays (4 pm to 5.30 pm on Zoom) reserved for AQM questions. Please send me an email by Monday morning (10 a.m.) if you want to come by. If you already have specific questions you want to ask, include them already so that I can plan and prepare for your questions ahead of time. If Monday does not work for you at all, send me an email and we can make an appointment.
...
This is a challenging course in a challenging time. It is also an elective course, so I expect a high level of commitment towards the learning goals of the course. However, the pandemic puts a significant strain on all of us and, of course, also affects our performance capacity. For that reason, I would like to emphasize some points:

  + This course should be up high on your priority list, but **your health--physical and mental--definitely has highest priority**. 
  + My goal is that you learn as much as possible. I won't achieve this goal if your mental healths suffers under this course. I will have an open ear and try to find individual solutions if you think that this is nevertheless the case. 
  + Things that help me (this might be different for you):
    ...
    + Building a stable weekly routine that helps me to avoid situations in which I have to finish work just before a deadline. Startig early on homework assignments is part of this.
...
When talking about "matrix-muliplication", we usually refer to the "matrix product" which differs from elementwise multiplication. Let's start with the multiplication of a vector and a matrix:
